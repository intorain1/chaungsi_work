...
if __name__ == "__main__":
    ...
    model = detr_resnet50(False, 6)
    state_dict = torch.load('/home/featurize/eval1/eval/latest.pth') #TODO change to your model path
    ...
    image_file_path =  os.listdir("/home/featurize/inference_demo/detect_demo") #TODO if you are using image folder with multiple images, use this. or you can simply change it to singel image path like line105-108
    save_dir = '/home/featurize/output'
    for image_item in image_file_path:
        image_path = os.path.join("/home/featurize/inference_demo/detect_demo", image_item)
